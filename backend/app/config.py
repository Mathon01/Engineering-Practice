...
class Settings:
    ...
    auto_seed_demo_data: bool = _bool("AUTO_SEED_DEMO_DATA", True)
    database_url: str = os.getenv(
        "DATABASE_URL",
        f"sqlite:///{(BASE_DIR / 'data' / 'market_agent.db').as_posix()}",
    ) or f"sqlite:///{(BASE_DIR / 'data' / 'market_agent.db').as_posix()}"
    ...
    market_data_primary: str = os.getenv("MARKET_DATA_PRIMARY", "demo")
