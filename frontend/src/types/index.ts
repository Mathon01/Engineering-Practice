...
export interface NewsItem { id: number; scope: string; title: string; summary?: string | null; source: string; url?: string | null; sentiment: string; importance: number; published_at?: string | null; code?: string; name?: string; stock?: Stock; }
